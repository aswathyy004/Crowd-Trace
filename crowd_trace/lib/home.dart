  ...
  void _showMissingDialog() {
    showGeneralDialog(
      ...
      pageBuilder: (ctx, _, __) => _PickDialog(
        ...
        Navigator.push(context, _slide(const ViewMissingPersonsPage(shopId: ''))); },
        ...
        SliverToBoxAdapter(child: FadeTransition(opacity: _af(0,.38),
            child: SlideTransition(position: _as(0,.38),
                child: _DashTop(
                  ...
                  onMissing: () => _push(const ViewMissingPersonsPage(shopId: '')),
                )))),
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Row(children: [
          _StatTile(
            ...
            loaded: loaded,
            onTap: () => onPush(const ViewMissingPersonsPage(shopId: '')),
          ),
          const SizedBox(width: 10),
          _StatTile(
  ...
  Widget build(BuildContext context) {
    final items = [
      ...
      _QItem('Missing Persons', 'View records',     Icons.person_search_rounded,        _T.accentPurple,
              () => onPush(const ViewMissingPersonsPage(shopId: ''))),
...
class _CarouselSectionState extends State<_CarouselSection> {
  ...
  Widget build(BuildContext context) {
    ...
    final page   = _showMissing
        ? const ViewMissingPersonsPage(shopId: '')
