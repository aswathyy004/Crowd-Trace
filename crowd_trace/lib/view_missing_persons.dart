...
class ViewMissingPersonsPage extends StatefulWidget {
  final String shopId;
  const ViewMissingPersonsPage({super.key, required this.shopId});
                      ...
                      children: [
                        Row(children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              color: ((p['status'] ?? '').toString().toLowerCase() == 'closed'
                                  ? _T.success
                            ...
                            child: Text(
                              (p['status'] ?? '').toString().toLowerCase() == 'closed'
                                  ? "CLOSED"
                                  : "ACTIVE",
                              style: TextStyle(
                                color: (p['status'] ?? '').toString().toLowerCase() == 'closed'
...
class _StatusCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final isClosed = (person['status'] ?? '').toString().toLowerCase() == 'closed';
    final color = isClosed ? _T.success : _T.danger;
        ...
        child: Container(
          ...
          child: Row(children: [
            ...
            Column(
              ...
              children: [
                Text(
                  isClosed ? "Case Closed" : "Case Active",
                  style: TextStyle(
                    color: color,
                    fontSize: 15,
                    fontWeight: FontWeight.w800,
